...
public class TransactionController {
    ...
    public ResponseEntity<CreditWalletResponse> creditUserWallet(@RequestBody CreditWalletJson req) throws Exception {
    ...
    public ResponseEntity<CreditWalletResponse> transferCreditToAnotherUser(@RequestBody MakeTransactionJson req) throws Exception {
    ...
    public ResponseEntity<CreditRequestResponse> requestForCredit(@RequestBody MakeTransactionJson req) throws Exception {
    ...
    public ResponseEntity<CreditWalletResponse> acceptCreditRequest(@RequestBody ActionOnCreditRequestJson req) throws Exception {
    ...
    public ResponseEntity<ResponseCodeJson> rejectCreditRequest(@RequestBody ActionOnCreditRequestJson req) throws Exception {
        logger.info("Accept credit request: " + req);
